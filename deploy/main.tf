...
resource "aws_security_group" "k8s-security-group" {
  ...
  tags = {
    yor_trace = "5df02023-254d-4c9c-b899-a3d00a0db5e9"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-master" {
  ...
  tags = {
    yor_trace = "44cf9fae-7e09-465a-bb64-54e772dba0b4"
  }
}
...
resource "aws_instance" "ci-sockshop-k8s-node" {
  ...
  tags = {
    yor_trace = "d95295b3-86bd-4a2e-ab2d-b724035af3c9"
  }
}
...
resource "aws_elb" "ci-sockshop-k8s-elb" {
  ...
  tags = {
    yor_trace = "a1a481d4-442c-4777-83fc-a51bc95df438"
  }
}
